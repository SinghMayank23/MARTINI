...
public:
  ...
  bool init2( double jetpTmin, bool doMIinit, Info* infoPtrIn, BeamParticle* beamAPtrIn, 
    BeamParticle* beamBPtrIn, SigmaTotal* sigmaTotPtrIn, 
    ostream& os = cout);
...
private: 
  ...
  double alphaSvalue, Kfactor, pT0Ref, ecmRef, ecmPow, 
         pTmin, mypTmin, coreRadius, coreFraction, expPow;

  // Other initialization data.
  bool   hasLowPow;
  double eCM, sCM, pT0, mypT0, pT20, mypT20, pT2min, mypT2min, pTmax, pT2max, pT20R, pT20minR, mypT20minR, 
         pT20maxR, mypT20maxR, pT20min0maxR, mypT20min0maxR, pT2maxmin, mypT2maxmin, sigmaND, pT4dSigmaMax, 
         ...
         expRev, cDiv, cMax, jetXSec, totalXSec, elasticXSec;
  ...
  //added by Bjoern Schenke 27/08/2009 to pass cross sections to MARTINI
  double mysigmaPT2(bool isFirst = false);
