...
private:
  ...
  bool   doQCDshower, doQEDshowerByQ, doQEDshowerByL, doQEDshowerByGamma, 
         doMEcorrections, doPhiPolAsym, allowBeamRecoil, doMedium;
  ...
  double pTmaxFudge, mc, mb, m2c, m2b, alphaSvalue, alphaS2pi, 
         ...
         octetOniumFraction, octetOniumColFac, mZ, gammaZ, thetaWRat, tauHydro;
  //doMedium and tauHydro added by Bjoern Schenke 09/28/2009
