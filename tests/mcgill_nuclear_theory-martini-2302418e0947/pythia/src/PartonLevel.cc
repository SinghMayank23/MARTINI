...
bool PartonLevel::init( double jetpTmin, Info* infoPtrIn, BeamParticle* beamAPtrIn, 
  ...
  doMI = multi.init2( jetpTmin, doMIinit, infoPtr, beamAPtr, beamBPtr, sigmaTotPtr);
  jetXSec = multi.returnJetCrossSection();
  totalXSec = multi.returnTotalCrossSection();
  elasticXSec = multi.returnElasticCrossSection();
