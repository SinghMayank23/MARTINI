...
bool MultipleInteractions::init2( double jetpTmin, bool doMIinit, Info* infoPtrIn, 
  BeamParticle* beamAPtrIn, BeamParticle* beamBPtrIn, 
  SigmaTotal* sigmaTotPtrIn, ostream& os) {
...
void MultipleInteractions::upperEnvelope2() {  
...
// added by Bjoern Schenke 08/27/2009 to compute jet cross section 
// given a certain minimal p_T cutoff and pass it to MARTINI
void MultipleInteractions::jetCrossSection2() {

  // Common factor from bin size in dpT2 / (pT2 + r * pT20)^2 and statistics.   
  double sigmaFactor = (1. / mypT20minR - 1. / mypT20maxR) / (NBINS * nSample);
...
// added by Bjoern Schenke 08/27/2009 to compute jet cross section 
// given a certain minimal p_T cutoff and pass it to MARTINI
double MultipleInteractions::mysigmaPT2(bool isFirst) {
