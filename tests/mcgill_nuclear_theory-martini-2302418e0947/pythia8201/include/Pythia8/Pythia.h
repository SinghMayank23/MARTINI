...
public:
  ...
  // Generate the next event. - added option to select neutron - added by Bjoern Schenke 09/08/09
  bool next(int n1=2212, int n2=2212); 
  ...
  // return the elastic cross section 
  double elasticCrossSection() const {return elasticXSec;}
  // return the total cross section 
  double totalCrossSection() const {return totalXSec;}
  // return the jet cross section 
  double jetCrossSection() const {return jetXSec;}
  // return the total jet cross section 
  double totaljetCrossSection() const {return totaljetXSec;}
  // jet minimal&maximum pT to use when using MARTINI
  void setJetpTmin(double value) {jetpTmin = value;}
  void setJetpTmax(double value) {jetpTmax = value;}
...
private:
  ...
  // added by Bjoern Schenke 27/08/2009 to pass cross sections to MARTINI
  // total and jet cross section to be passed to MARTINI
  double elasticXSec;
  double totalXSec;
