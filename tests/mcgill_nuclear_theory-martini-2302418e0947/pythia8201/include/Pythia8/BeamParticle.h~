...
public:
  ...
  // Is beam a neutron? - added by Bjoern Schenke 09/08/2009
  int AbsidNow() {return idBeamAbsNow;}
  void AbsidNow(int value) {idBeamAbsNow = abs(value);}
...
//    { return pdfBeamPtr->xfVal(idIn, x, Q2, idBeamAbsNow);}
    { return pdfBeamPtr->xfVal(idIn, x, Q2);}
  double xfSea(int idIn, double x, double Q2)
//    { return pdfBeamPtr->xfSea(idIn, x, Q2, idBeamAbsNow);}
...
private:
  ...
  int    idBeam, idBeamAbs, idBeamAbsNow;
  Vec4   pBeam;
  double mBeam;
