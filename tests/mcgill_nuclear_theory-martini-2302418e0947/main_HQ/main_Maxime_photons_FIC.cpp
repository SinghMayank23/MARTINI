...
int main(int argc, char* argv[]) 
{
  ...
  martini.readFile("setup_main_Maxime_photons_FIC.dat");
  ...
  n_string = "RHIC_ideal_lattice_FIC_"+n_string;
  ////Output the events:
  ...
  string e_name = "photons_"+n_string+".dat";
  string e_name_f = "photons_fragmented_"+n_string+".dat";
