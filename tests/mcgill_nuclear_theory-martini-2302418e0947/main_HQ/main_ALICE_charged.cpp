...
int main(int argc, char* argv[]) 
{
  ...
  martini.readFile("setup_main_ALICE_charged.dat");
  ...
  n_string = "PbPb_Ldependence1_alphas25_"+n_string;
  ...
  //Output the events:
  string e_name = "/imports/pyramid/cyoung/MARTINI_dijets/RAAEvents_"+n_string+".dat";
