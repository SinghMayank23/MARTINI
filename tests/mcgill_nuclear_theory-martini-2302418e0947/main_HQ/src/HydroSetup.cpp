			       ...
			       int whichHydro, int subset, bool viscous, double b, vector<HydroCell> *lattice, string evolution_name)
{
  ...
  else if (whichHydro==4 || whichHydro==6 || whichHydro==7) // 3+1D MUSIC hydro (Schenke, Jeon, Gale) (for 4, just 1 quarter of the transverse plane, 6 all)
    {
      ifstream fin;
      string sent;
      ostringstream temp;
				     ...
				     int fixedDistribution, vector<HydroCell>* lattice, bool trackHistory)
{
  ...
  //This is a fucking nightmare! I am going to do this with 4-dimensional arrays:
  //if( hydroWhichHydro == 7){
  //  
  //
  //  return;
  //}
