...
#include <cmath>
#include <list>
#include "Pythia.h"            // include Pythia
...
class MARTINI
{
 ...
 public:
  ...
  int fragmentation_HQ(vector<Parton> ** plist);
  ...
  int generateEvent_HQ(vector<Parton> *plist);
  ...
  int evolve_HQ(vector<Parton>  **plist, int counter, int it);
