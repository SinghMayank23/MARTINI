...
class Rates
{
 ...
 public:
  ...
  Norms integrate(double p, double T, double alpha_s, int Nf, int Ldependence, double L, bool runningCoupling);
  Norms integratePosOld(double p, double T, double alpha_s, int Nf);
  Norms integrateNegOld(double p, double T, double alpha_s, int Nf);
  Norms integrateOld(double p, double T, double alpha_s, int Nf, int Ldependence, double L);
