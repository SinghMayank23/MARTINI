...
bool PartonLevel::init( double jetpTmin, double jetpTmax, Info* infoPtrIn, Settings& settings,
  ...
  doMPIMB  =  multiMB.init2( jetpTmin, jetpTmax, doMPIinit, 0, infoPtr, settings, 
    particleDataPtr, rndmPtr, beamAPtr, beamBPtr, couplingsPtr, partonSystemsPtr,
    sigmaTotPtr, userHooksPtr);
  jetXSec = multiMB.returnJetCrossSection();


  totalXSec = multiMB.returnTotalCrossSection();
  elasticXSec = multiMB.returnElasticCrossSection();
  doMPIMB  =  multiMB.init( doMPIinit, 0, infoPtr, settings, particleDataPtr,
    ...
    userHooksPtr);
  totaljetXSec = multiMB.returnTotalJetCrossSection();
